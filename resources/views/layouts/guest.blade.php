...
<body class="min-h-screen flex flex-col bg-brand-black text-white font-sans antialiased">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-brand-black/90 backdrop-blur-md border-b border-white/5"
        id="navbar">
    ...
    <footer class="bg-brand-dark border-t border-white/5">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-12 py-16">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        <li><a href="{{ route('city.show', 'abidjan') }}"
                                class="text-white/60 hover:text-white transition">Abidjan</a></li>
                        <li><a href="{{ route('accompagnement') }}"
                                class="text-white/60 hover:text-white transition">Accompagnement</a></li>
                        <li><a href="{{ route('faq') }}" class="text-white/60 hover:text-white transition">FAQ</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-white/60">
                        ...
                        <li><a href="mailto:contact@ckfmotors.com"
                                class="hover:text-white transition">contact@ckfmotors.com</a></li>
                    </ul>
                </div>
                <div class="flex flex-col items-start md:items-end">
                    <a href="{{ route('home') }}" class="text-lg font-bold tracking-[0.2em] uppercase mb-6">CKF
                        MOTORS</a>
            ...
            <div class="mt-12 pt-8 border-t border-white/5 text-center text-xs text-white/30">
                &copy; {{ date('Y') }} CKF Motors. Tous droits réservés.
            </div>
        </div>
    </footer>
